...
<style>
    ...
    <body>
        <nav class="navbar navbar-fixed-top kotlini" style="background-color:#876822;">
            <div class="navbar-header">
                <a class="navbar-brand" href="Home.php">&lt;C<b style="color: red;">&#x2764;</b>C&gt;</a>
            </div>
            <h1 class="text-center"><b>Kotlin</b></h1>    
        </nav>
        ...
        <div class="container">
            <div class="row land">
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <ul>
                            <li><p><b>Kotlin</b> is a statically typed programming language for modern multiplatform applications. It was developed by <b>JetBrains</b>, a software development company. </p></li>
                            
                            <li><p>At <b>Google I/O 2017</b>, Google announced <b>first-class support for Kotlin on Android</b>.</p></li>
            
                            <li><p><b>Kotlin</b> is now an <b>official language on Android</b>. Many apps are already built with Kotlin from the <b>hottest startups to Fortune 500 companies</b>.</p></li>
            
                            <li><p>Kotlin is <b>concise</b> while being expressive. It contains <b>safety features</b> for nullability and immutability, to make your <b>Android apps healthy</b> and performant by default.</p></li>
                        </ul>
                        <h4 class="kotlin-h4"><b>Modern. &nbsp;Expressive. &nbsp;Safe.</b></h4>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card"><img src="Images/jetbrains.png" style="width:100%;opacity:0.85"height="70%">
        ...
        <div class="container">
			...
			echo"<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,documentations from kotlin order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['documentations']== null)
						{
							echo "<div class='w3-col' style='width:inherit'><div class='card kotlin foo'> ";
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='documentations'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,courses from kotlin order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['courses']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='courses'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,youtube from kotlin order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['youtube']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='youtube'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo "<div class='w3-row'>";
				$sql = "select id,apps from kotlin order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['apps']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='apps'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
        ...
        <img class="mid" src="Images/kotlin.png">
        <h1 class="ft"><b>#makebykotlin</b></h1>
