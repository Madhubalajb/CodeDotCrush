...
<style>
    ...
    <body>
        <nav class="navbar navbar-fixed-top jqi" style="background-color:#F75940;">
            <div class="navbar-header">
                <a class="navbar-brand" href="Home.php">&lt;C<b style="color:aqua;">&#x2764;</b>C&gt;</a>
            </div>
            <h1 class="text-center"><b>jQuery</b></h1>    
        </nav>
        ...
        <div class="container">
            <div class="row land">
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <ul>
                            <li><p><b>jQuery</b> is a lightweight JavaScript library. It was released by <b>John Resig</b> on <b>January 26, 2006</b> with several additional releases since then.</p></li>
            
                            <li><p>The purpose of jQuery is to make it much easier to use <b>JavaScript</b> on your website. jQuery simplifies HTML document traversing, event handling, animating, and Ajax interactions for rapid web development.</p></li>
                            
                            <li><p> It is the library that is <b>beloved</b> <svg class="heart" viewBox="0 0 32 29.6">
            <path d="M23.6,0c-3.4,0-6.3,2.7-7.6,5.6C14.7,2.7,11.8,0,8.4,0C3.8,0,0,3.8,0,8.4c0,9.4,9.5,11.9,16,21.2
                     c6.1-9.3,16-12.1,16-21.2C32,3.8,28.2,0,23.6,0z"/>
            </svg> by most of the web developers for scripting. It is very easy to learn, have a good documentation and a big community.</p></li>
            
                            <li><p>Many of the biggest companies on the Web use jQuery, such as: <b>Google, Microsoft, IBM, Netflix .</b></p></li>
                        </ul>
                        <h4 class="jq-h4"><b>Write less! &nbsp; Do more!!</b></h4>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card"><img src="Images/John%20Resig.jpg" style="width:100%;opacity:0.85"height="70%">
                        <div class="container1">
                            <h4><b>John Resig</b></h4>
                            <p>American software engineer</p>
                        </div>
                    </div>
                </div>       
            </div>
        ...
        <div class="container">
			...
			echo"<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,documentations from jquery order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['documentations']== null)
						{
							echo "<div class='w3-col' style='width:inherit'><div class='card jq foo'> ";
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='documentations'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,courses from jquery order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['courses']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='courses'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,youtube from jquery order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['youtube']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='youtube'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo "<div class='w3-row'>";
				$sql = "select id,apps from jquery order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['apps']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='apps'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
        ...
        <h1 class="ft"><b>Write less ! Do more !! with jQuery .</b></h1>    
