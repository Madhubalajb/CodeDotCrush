...
<style>
    ...
    <body>
        <nav class="navbar navbar-fixed-top phpi" style="background-color:dodgerblue;">
            <div class="navbar-header">
                <a class="navbar-brand" href="Home.php">&lt;C<b style="color: red;">&#x2764;</b>C&gt;</a>
            </div>
            <h1 class="text-center"><b>PHP</b></h1>    
        </nav>
        ...
        <div class="container">
            <div class="row land">
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <ul>
                            <li><p><b>PHP</b> is short for <b>Hypertext Preprocessor</b>. First developed by <b>Rasmus Lerdorf</b> in <b>1994</b> and publicly released <b>June 8, 1995</b>. PHP is a <b>server-side</b> interpreted scripting language.</p></li>
                            
                            <li><p>It was designed for creating <b>dynamic web pages</b> and web pages that  works with <b>databases</b> effectively. PHP is compatible with almost any modern server, such as Apache, IIS, and more.</p></li> 
                            
                            <li><p>PHP is a <b>server side scripting</b> language that is embedded in <b>HTML</b>. It is used to manage dynamic content, databases,session tracking, even build entire e-commerce sites.</p></li>
                            
                            <li><p>PHP was originally designed to replace a set of <b>Perl scripts</b> to maintain <b>Personal Home Pages</b> (also known as PHP).</p></li>
                            
                            <li><p>Files that include PHP code on a web server may have any file extension, but most commonly they end in <b>.PHP, .PHP3, or .PHTML</b>.</p></li>
                        </ul>      
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card"><img src="Images/Rasmus-Lerdorf.jpg" style="width:100%;opacity:0.85"height="70%">
                        <div class="container1">
                            <h4><b>Rasmus Lerdorf</b></h4>
                            <p>Danish-Canadian programmer</p>
                        </div>
                    </div>
                </div>       
            </div>
        ...
        <div class="container">
			...
			echo"<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,documentations from php order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['documentations']== null)
						{
							echo "<div class='w3-col' style='width:inherit'><div class='card php foo'> ";
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='documentations'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,courses from php order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['courses']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='courses'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo"<div class='w3-row'>";
				$sql = "select id,youtube from php order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['youtube']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='youtube'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
			...
			echo "<div class='w3-row'>
            	...
            	echo "<div class='w3-row'>";
				$sql = "select id,apps from php order by id asc"; 
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
        				if(!$row['apps']== null)
...
<div class='heartbutton' data-post_id='102' data-post_animation='season1' value='".$row['id']."' name='apps'>
	...
	<img class='heart-icon-animation heartsize' src='http://machineboy.com/bilder/heart-icon-explode.svg'/>
        ...
        <h1 class="ft"><b>Rule the server with PHP !!</b></h1>
