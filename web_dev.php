...
<html lang="en">
<head>
    <title>Explore cool Web Tips </title>
...
<style>
	...
	<nav class="navbar navbar-fixed-top">
        ...
        <div class="container">
            <div class="row land">
                <p>
					<span><b>Here the cool stuffs, to build some fancy, crazy, interesting things on the web ...</b>
					</span>
				</p>
            </div>
            ...
            <?php
				...
				$sql = "select id,things from web_dev order by id asc"; 
